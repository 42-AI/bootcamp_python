...
division) and the modulo operation. This should be accomplished by writing a
function that takes 2 numbers as parameters and returns 5 values, as formatted
...
Including the tuple above in your file, write a program that dynamically builds
up a formatted string like the following:
...
It is a \textit{lunch} and it takes \textit{10} minutes of preparation.  
Cake's ingredients are \textit{flour}, \textit{sugar} and \textit{eggs}.
It is a \textit{dessert} and it takes \textit{60} minutes of preparation.  
Salad's ingredients are \textit{avocado}, \textit{arugula}, \textit{tomatoes} and \textit{spinach}.
It is a \textit{lunch} and it takes \textit{15} minutes of preparation.  
...
\begin{enumerate}
	...
	\item Write a function to print a recipe from \texttt{cookbook}. The function parameter will be the name of the recipe.
	\item Write a function to delete a recipe from the dictionary. The function parameter will be the name of the recipe.
	\item Write a function to add a new recipe to \texttt{cookbook} with its ingredients, its meal type and its preparation time. The function parameters will be the name of recipe, ingredients, meal and prep\_time.
	\item Write a function to print all recipe names from \texttt{cookbook}. Think about formatting the output.
