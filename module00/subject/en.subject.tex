...
By default, conda will be installed in the goinfre (look at the `INSTALL\_PATH` variable). Feel free to change that path if you want to.
...
When the installation is done rerun the `set\_conda` function.
