...
def crop(self, array, dim, position=(0,0)):
    ...
    Return:
    -------
      new_arr: the cropped numpy.array.
...
def juxtapose(self, array, n, axis):
    ...
    Return:
    -------
      new_arr: juxtaposed numpy.array.
...
def invert(array):
    ...
    Args:
    -----
        array: numpy.array corresponding to the image.
    Return:
    -------
        array: numpy.array corresponding to the transformed image.
        None: otherwise.
    Raises:
    -------
        This function should not raise any Exception.
...
class KmeansClustering:
    ...
    def fit(self, X):
        ...
        Args:
        -----
          X: has to be an numpy.array, a matrice of dimension m * n.
        Return:
        -------
          None.
        Raises:
    ...
    def predict(self, X):
        ...
        Return:
        -------
          the prediction has a numpy.array, a vector of dimension m * 1.
        Raises:
        -------
          This function should not raise any Exception.
        """
