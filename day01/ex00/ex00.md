...
|   Files to turn in :    |  book.py<br>recipy.py<br>test.py  |
...
* `name`            (str)  
* `last_update`     ([datetime](https://docs.python.org/fr/3/library/datetime.html#datetime.datetime))  
* `creation_date`   ([datetime](https://docs.python.org/fr/3/library/datetime.html#datetime.datetime))  
