...
As an introduction, complete a short questionnaire using Python and `pip` and check your answers with your peers.
...
5. Freeze the packages and their current versions in a `requirements.txt` file.
