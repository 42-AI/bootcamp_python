...
This is time to discover Python dictionaries. Dictionaries are collections that contain mappings of unique keys to values.
...
Your program must continue running until the user doesn't exit (option 5):
